      ...
      <div class="card-body">
        ...
        <div id="pay-invoice">
            <div class="card-body">
                ...
                {{ Form::model($photo,['route'=> ['photo-update', $photo->id], 'method'=> "PUT",'enctype' => 'multipart/form-data']) }}
                  ...
                  <div class="form-group">
                    ...
                    {{Form::select('album[]',$album,$selectedAlbum,['class'=> 'form-control myselect', 'data-placeholder'=> "Select albums", 'multiple'])}}  
                  </div>
